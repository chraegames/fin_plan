  ...
  switch (preset) {
    ...
    case 'mid': {
      ...
      return {
        ...
        birthYear,
        startingCash: 80000,
        brokerageBalance: 500000,
        brokerageBasis: 380000,
        rothBalance: 250000,
        iraBalance: 370000,
        returnRate: 0.06,
        inflationRate: 0.03,
    ...
    case 'approaching': {
      ...
      return {
        ...
        birthYear,
        startingCash: 200000,
        brokerageBalance: 900000,
        brokerageBasis: 600000,
        rothBalance: 500000,
        iraBalance: 800000,
        returnRate: 0.05,
        inflationRate: 0.03,
        ...
        expenses: [
          {
            ...
            frequency: 'monthly',
            applyInflation: true,
            periods: [{ startYear, endYear, amount: 9000 }],
          },
          {
            id: 'exp-2',
            name: 'Health insurance',
          ...
          },
          {
            ...
            frequency: 'annual',
            applyInflation: true,
            periods: [{ startYear, endYear, amount: 25000 }],
          },
          {
            id: 'exp-4',
            name: 'Property tax',
            frequency: 'annual',
            applyInflation: true,
            periods: [{ startYear, endYear, amount: 18000 }],
          },
        ],
        withdrawals: [],
      };
